...
const SMALL_NOTE =
  'CONCLUSION AT SMALL SIZES. 37 ms is not a wait — if you test on a few thousand elements you ' +
  'might reasonably conclude both algorithms are fine, and for that array you would be right. The ratio ' +
  'is already 67 to 1, but neither number is big enough to hurt. This is exactly why slow algorithms ' +
  'survive testing: at the sizes you try first, everything works.';
