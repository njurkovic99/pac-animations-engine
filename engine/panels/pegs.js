 ...
 * a peg). All fixed, so the bundle is the same size wherever it sits. */
const B_BARS = 5, B_BAR_H = 5, B_BAR_GAP = 4;
const B_MAXW = 90, B_MINW = 46;            // bottom (widest) → top (narrowest) line
const B_BARS_H = B_BARS * B_BAR_H + (B_BARS - 1) * B_BAR_GAP;   // lines block height
const B_LABEL_H = 15;                       // reserved for the "n − 1 disks" label
const BUNDLE_H = B_BARS_H + 4 + B_LABEL_H;  // whole bundle block height
