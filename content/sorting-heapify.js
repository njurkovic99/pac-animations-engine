...
function* trace() {
  ...
  // FINAL — the loop test fails, heapify returns, the heap is complete. The note
  // links FORWARD to part 2: the student, now holding a max heap and asked how they
  // would sort with it, can go watch exactly that.
  yield snap({ line: 14, tag: 'test', level: 1,
    note: [FINAL_NOTE, ' ', { href: 'sorting-heapsort-dual.html', text: 'See how the values actually get sorted' }],
